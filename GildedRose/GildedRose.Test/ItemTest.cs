...
namespace GildedRose.Test
{
    ...
    public class ItemTest
    {
        ...
        public void Assess()
        {
            ...
            Assert.AreEqual(Item.Standard("0 sellin still decreases by 1", -1, 4), Item.Standard("0 sellin still decreases by 1", 0, 5).Assess());
            ...
            Assert.AreEqual(Item.Conjured("conjured", 4, 3), Item.Conjured("conjured", 5, 5).Assess());
            Assert.AreEqual(Item.Conjured("does not go below 0", 4, 0), Item.Conjured("does not go below 0", 5, 1).Assess());
            Assert.AreEqual(Item.Conjured("0 sellin still decreases by 2", -1, 3), Item.Conjured("0 sellin still decreases by 2", 0, 5).Assess());
            Assert.AreEqual(Item.Conjured("below 0 sellin decreases by 4", -2, 1), Item.Conjured("below 0 sellin decreases by 4", -1, 5).Assess());
        }
    }
}